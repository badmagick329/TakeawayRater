...
class RestaurantModelTest(TestCase):
    def test_creation(self):
        ...
        restaurant = Restaurant.objects.create(name="test", url="https://test.com")
    ...
    def test_duplicate_creation_fail(self):
        ...
        with self.assertRaises(ValidationError):
            restaurant2 = Restaurant.objects.create(name="TEST", url="https://test.com")
        self.assertEqual(Restaurant.objects.count(), 1)
    ...
    def test_duplicate_url_creation_fail(self):
        ...
        self.assertEqual(Restaurant.objects.count(), 1)
        with self.assertRaises(ValidationError):
            Restaurant.objects.create(name="test3", url="https://test.com/?a=1")
        self.assertEqual(Restaurant.objects.count(), 1)

    def test_duplicate_url_creation_fail_2(self):
        """Test that a restaurant cannot be created with the same url"""
        restaurant = Restaurant.objects.create(name="test", url="https://test.com?a=1")
        self.assertEqual(Restaurant.objects.count(), 1)
        with self.assertRaises(ValidationError):
            Restaurant.objects.create(name="test2", url="https://test.com?a=5")
        self.assertEqual(Restaurant.objects.count(), 1)
        with self.assertRaises(ValidationError):
            Restaurant.objects.create(name="test3", url="https://test.com/?a=6")
        self.assertEqual(Restaurant.objects.count(), 1)
    ...
    def test_duplicate_url_creation_pass(self):
        ...
        restaurant = Restaurant.objects.create(name="test", url="https://test.com")
        self.assertEqual(Restaurant.objects.count(), 1)
        restaurant2 = Restaurant.objects.create(name="test2", url="https://test2.com")
