...
<div class="order">
  <div class="input-field">
    <div
      class="error-field"
      style={errors.restaurant ? "display:block;" : "display:none;"}
    >
  ...
  <div class="input-field">
    <div
      class="error-field"
      style={errors.url ? "display:block;" : "display:none;"}
    >
  ...
  {#each order.foods as food, i}
    <div class="food-input">
      <div class="input-field">
        <div
          class="error-field"
          style={errors.foods[i] ? "display:block;" : "display:none;"}
        >
      ...
      <div class="input-field">
        <input
          type="text"
          name={`tags-${i}`}
          bind:value={order.foods[i].tagsStr}
      ...
      <div class="input-field">
        <input
          type="text"
          name={`comment-${i}`}
          bind:value={order.foods[i].comment}
      ...
      <div class="input-field">
        <input
          ...
          name={`image-${i}`}
          accept="image/*"
          on:input={(e) => readImage(e, i)}
        />
        <input
          class="link-input"
          type="text"
          name={`image-link-${i}`}
          bind:value={order.foods[i].imageUrl}
        ...
        {#if previews[i]}
          <img
            class="preview-image"
            src={previews[i]}
            alt={order.foods[i].name}
          />
        {:else if order.foods[i].imageUrl}
          <img
            class="preview-image"
            src={order.foods[i].imageUrl}
            alt={order.foods[i].name}
          />
        {/if}
      </div>
